    ...
    <div class="sidebar">
        @if(!Auth::user()->is_super_admin)
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{url('/panel')}}" class="d-block">{{Auth::user()->username}}</a>
                </div>
            </div>
        @endif
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{route("categories.index")}}"
                       class="nav-link {{ Request::is('panel/categories') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('posts.index')}}"
                               class="nav-link {{ Request::is('panel/posts') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('posts.create')}}"
                               class="nav-link {{ Request::is('panel/posts/create') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link {{ Request::is('panel/new-announcements') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="pages/layout/top-nav.html"
                               class="nav-link {{ Request::is('panel/roles') ? 'active' : '' }}">
